...
public class SubmitFieldHandler implements FieldHandler {

	private static final Logger _LOGGER = LoggerFactory.getLogger(SubmitFieldHandler.class);
	...
	public WebElement getElement(final WebDriver webDriver, final HtmlField htmlField) {
		...
		if(htmlField.getFieldSelector() == FieldSelector.ID) {
			...
			webElement = webDriver.findElement(By.className(htmlField.getName()));
		}
